...
schema = [
    ...
    ,{
        ...
        ,definition : {
            ...
            ,"desc" : "일반 사용자"
            ,"properties" : [
                 { "key"   : {"name" : "아이디"                    } , "value" : {"type" : "string" , "default":'' , "desc" : ""   }}
                ,{ "key"   : {"name" : "비밀번호"                    } , "value" : {"type" : "string" , "default":'' , "desc" : ""   }}
                ,{ "key"   : {"name" : "출금계좌번호"           } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 출금 비밀번호" }}
                ,{ "key"   : {"name" : "이름"                  } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 명" }}
                ,{ "key"   : {"name" : "휴대폰"             } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 전화번호" }}
                ,{ "key"   : {"name" : "레벨"                 } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 등급" }}
                ,{ "key"   : {"name" : "보유금액"                 } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 보유 금액" }}
                ,{ "key"   : {"name" : "보유포인트"                 } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 보유 포인트" }}
                ,{ "key"   : {"name" : "가입일시"      } , "value" : {"type" : "object" , "default":{} , "desc" : "사용자 가입 일시" }}
                ,{ "key"   : {"name" : "가입IP"            } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 가입 IP" }}
                ,{ "key"   : {"name" : "은행계좌번호"          } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 은행 계좌 번호" }}
                ,{ "key"   : {"name" : "은행명"             } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 은행 명" }}
                ,{ "key"   : {"name" : "은행계좌주명"       } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 은행 계좌주명" }}
                ,{ "key"   : {"name" : "최종접속일시"   } , "value" : {"type" : "object" , "default":{} , "desc" : "최종접속일시" }}
                ,{ "key"   : {"name" : "메모"                  } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 메모" }}
                ,{ "key"   : {"name" : "간단메모"           } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 간단 메모" }}
                ,{ "key"   : {"name" : "소속매장_id"             } , "value" : {"type" : "string" , "default":'' , "desc" : "사용자 소속 매장 _id. 총판에 바로 소속은 불가." }}
            ]
        }}
    ,{
        name : 'userMoneyLogs'
        ,definition : {
            ...
            ,"desc" : "사용자 머니 입출금 로그"
            ,"properties" : [
                 { "key"   : {"name" : "아이디"                    } , "value" : {"type" : "string" , "default":'' , "desc" : "로그 사용자 ID" }}
                ...
                ,{ "key"   : {"name" : "거래요청일시"          } , "value" : {"type" : "object" , "default":null , "desc" : "거래 요청 일시. 거래 완료 시에 실제 입금 출금 등이 이루어짐." }}
                ,{ "key"   : {"name" : "거래완료일시"           } , "value" : {"type" : "object" , "default":null , "desc" : "거래 완료 일시. 거래 요청이 들어왔을 때, 관리자가 처리 후 확인을 해주었을 때 셋팅. 본 필드 삽입 후 user 콜렉션에 실제 금액 셋팅. (본 필드가 null 이면 아직 진행중인 요청임) " }}
    ...
    ,{
        ...
        ,definition : {
            ...
            ,"desc" : "종목명 (축구/농구)"
            ,"properties" : [
                 { "key"   : {"name" : "이미지"          },"value" : {"type" : "object" , "default":null , "desc" : "종목 이미지 (공모양 / 깃발 등)" }}
    ...
    ,{
        ...
        ,definition : {
            ...
            ,"properties" : [
                 { "key"   : {"name" : "게임시작일시"            },"value" : {"type" : "object" , "default":null , "desc" : "게임시작일시" }}
                ,{ "key"   : {"name" : "게임종료일시"           },"value" : {"type" : "object" , "default":null , "desc" : "게임종료일시" }}
                ,{ "key"   : {"name" : "게임생성일시"          },"value" : {"type" : "object" , "default":null , "desc" : "게임이 생성된 일시" }}
